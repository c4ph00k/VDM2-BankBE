...
class BalanceResponse {
  ...
  @override
  String toString() => 'BalanceResponse[accountId=$accountId, balance=$balance, currency=$currency]';
  ...
  static Map<String, List<BalanceResponse>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = BalanceResponse.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
